package org.tonylimps.filerelay.windows;

import org.tonylimps.filerelay.core.threads.ConnectThread;
import org.tonylimps.filerelay.core.threads.HeartBeatThread;
import org.tonylimps.filerelay.core.threads.TokenThread;
import org.tonylimps.filerelay.windows.managers.WindowManager;
import org.tonylimps.filerelay.windows.managers.WindowsExceptionManager;
import org.tonylimps.filerelay.windows.managers.WindowsProfileManager;
import org.tonylimps.filerelay.windows.managers.WindowsResourceBundleManager;
import org.tonylimps.filerelay.windows.threads.WindowsUpdateThread;
...
public class Main extends Application{
	...
	public static void main(String[] args) {
		...
		connectThread = new ConnectThread(exceptionManager, running, profileManager, tokenThread.getToken());
		connectThread.start();
		logger.info("Connect thread started.");
		heartBeatThread = new HeartBeatThread(exceptionManager, running, profileManager, tokenThread.getToken(), connectThread);
